...
package com.legaoyi.iov.aws_iot_gateway.util;
...
public class CommandLineUtils {
     ...
     */
    public static SampleCommandLineData getInputForIoTSample(String sampleName)
    {
		String[] args = {
			"--endpoint", "a13p3ird4zt8ai-ats.iot.eu-central-1.amazonaws.com",
			"--client_id", "sdk-java",
			"--topic", "sdk/test/java",
			"--ca_file", "root-CA.crt",
